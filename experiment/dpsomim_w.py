...
if __name__=="__main__":
    ...
    ## 定义算法bpsomim
    dpsobmim = PSOBMIM(mlic, rcc, beta=0.4, num_particles=60, max_iterations=100, w=0.8, c1=1.2, c2=1.2, is_NO=False)
    changed_attr = {
        "CKM":{"beta":0.4},
        "Gallus":{"beta":0.4},
        "CElegans":{"beta":0.4},
    ...
    result = pl(w=list(np.arange(0.1, 1.01, 0.1)))
    print(result)
    save_json(result, os.path.join(RESULT_PATH, "result_dpsomim_np_100_ni_100_c1_1_8_c2_1_8_justify_w.json"))
