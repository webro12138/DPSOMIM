...
# 支持的多层网络数据集
BASE_MULTILAYER_NETWORK_DATASETS = ["Celegans", "arXiv-Netscience", "Sanremo2016", "Xenopus", "CKM", "Gallus", "LMT", "Rattus", "Mus", "PierreAuger", "SacchPomb", "HumanHIV1", "LMT", "EUAir", "CElegans", "Plasmodium", "HumanMicrobiome"]
